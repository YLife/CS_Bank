...
public class ClientResquestImpl implements ClientResquest {
	...
	public String deposit(String cardId, double money) {
		message = MessageFormat.format("deposit {0} {1}" , cardId , String.valueOf(money));
		return this.method();
	}

	@Override
	public String withDraw(String cardId, double money) {
		message = MessageFormat.format("withDraw {0} {1}", cardId , String.valueOf(money));
		return this.method();
	}

	@Override
	public String trans(String outCardId, String inCardId, double money) {
		message = MessageFormat.format("trans {0} {1} {2}", outCardId , inCardId , String.valueOf(money));
		return this.method();
	}
